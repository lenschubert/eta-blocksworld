...
(load "rules-for-breakfast-today-input.lisp")
(load "rules-for-favorite-icecream-input.lisp")
(load "rules-for-favorite-food-input.lisp")
(load "rules-for-how-you-got-here-input.lisp")
(load "rules-for-name-input.lisp")
(load "family-out.lisp")
(load "male-out.lisp")
(load "female-out.lisp")
;(format t "~%~%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ ~
