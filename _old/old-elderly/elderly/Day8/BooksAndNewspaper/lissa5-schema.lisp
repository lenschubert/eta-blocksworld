...
?a5. (Me say-to.v you '(How often do you read the newspaper?))
...
?a9. (Me say-to.v you '(Do you like to discuss politics and current events?))
...
; the next user input.
;
 '((?a1. ; What kinds of books do you like to read?
          ((What kinds of books do you like to read ?)))
   (?a5. ; How often do you read the newspaper?
          ((How often do you read the newspaper ?)))
   (?a9. ; Do you like to discuss politics and current events?
...
;
 '((?a1. ; What kinds of books do you like to read ?
   ...
   (?a5. ; How often do you read the newspaper ?
          (newspaper-how-often))
   (?a9. ; Do you like to discuss politics ?
          (like-politics))
   )); end of mapcar
