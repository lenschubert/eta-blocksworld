...
(setf *temp-dir* "elderly/Day7/Education")
;(setq path (pathname "C:/inetpub/wwwroot/RocSpeakRafayet/lissa5/elderly/Day7/Education/"))
(setf *default-pathname-defaults* (truename *temp-dir*))
(load "start-lissa5")
(setf *default-pathname-defaults* *root-dir*)
...
;    Employment
;================================
(setf *temp-dir* "elderly/Day7/Employment")
;(setq path (pathname "C:/inetpub/wwwroot/RocSpeakRafayet/lissa5/elderly/Day7/Employment/"))
(setf *default-pathname-defaults* (truename *temp-dir*))
(load "start-lissa5")
(setf *default-pathname-defaults* *root-dir*)
...
(setf *temp-dir* "elderly/Day7/LifeGoal")
;(setq path (pathname "C:/inetpub/wwwroot/RocSpeakRafayet/lissa5/elderly/Day7/LifeGoal/"))
(setf *default-pathname-defaults* (truename *temp-dir*))
(load "start-lissa5")
(setf *default-pathname-defaults* *root-dir*)
