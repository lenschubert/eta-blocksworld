...
?a5. (Me say-to.v you '(Do you think that naps during the day are helpful? ))
...
?a9. (Me say-to.v you '(Tell me about something you do to improve your sleep\.))
...
; the next user input.
;
 '((?a1. ; How well do you sleep at night? Has this changed as you\’ve gotten older?
          ((How do you sleep at night ?)))
   (?a5. ; Do you think that naps during the day are helpful? 
          ((Do you think that naps during the day are helpful ?)))
   (?a9. ; Tell me about something you do to improve your sleep.
...
;
 '((?a1. ; How do you sleep at night ?
          (sleep-quality))
   (?a5. ; Do you think that naps during the day are helpful ?
          (opinion-about-nap))
   (?a9. ; What do you do to improve your sleep ? 
          (improve-sleep))
   )); end of mapcar
