...
?a5. (Me say-to.v you '(What is your favorite season to be outdoors?))
...
?a9. (Me say-to.v you '(What do you enjoy doing when the weather keeps you indoors?))

?a10. (You reply-to ?a9.) ; again leads to a (READWORDS) call, and 
                         ; formation of a subordinate 
                         ; (you say-to.v me '(...)) plan
...
; the next user input.
;
 '((?a1. ; What is a recent outdoor activity you have done?
