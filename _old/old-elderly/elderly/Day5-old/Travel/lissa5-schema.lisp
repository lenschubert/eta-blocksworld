...
?a5. (Me say-to.v you '(Tell me about your favorite vacation\.))
...
?a9. (Me say-to.v you '(If you won a free trip with no restrictions\, including price\, where would you go and what would you do?))
...
; the next user input.
;
 '((?a1. ; What types of travel do you enjoy?
          ((What types of travel do you enjoy ?)))
   (?a5. ; Tell me about your favorite vacation.
          ((What does your favorite vacation look like ?)))
   (?a9. ; If you won a free trip with no restrictions, including price, where would you go and what would you do?
...
;
 '((?a1. ; What types of travel do you enjoy?
          (travel-enjoy))
   (?a5. ; What does your favorite vacation look like?
          (favorite-vacation))
   (?a9. ; If you won a free trip where would you go?
          (free-trip))
   )); end of mapcar
