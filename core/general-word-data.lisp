...
(eval-when (load eval)
  ...
  (MAPC (LAMBDA (TRIPLE) (SETF (GET (CAR TRIPLE) 'TWOWORDS) (CDR TRIPLE)))
	'((DON\'T DO NOT) (DONT DO NOT) (DOESN\'T DOES NOT) (DIDN\'T DID NOT)
	  ...
	  (THEY\'VE THEY HAVE) (GONNA GOING TO) (WANNA WANT TO)
	  ))
  ...
  (MAPC 'ATTACHFEAT
	'((FINISH FINISHED DONE QUIT STOP TERMINATE)
	  ...
	  (DET THE A AN MY YOUR HIS HER ITS OUR THEIR ALL EVERY EACH ANY
	       THIS THESE THOSE THAT SOME MANY ONE TWO THREE ANOTHER WH-DET
	  ...
	  (DEGR-ADV JUST EXACTLY PRECISELY); name changed from 'WH-ADV' 6/17/19
	  (INITADV TIMEADV DEGR-ADV)
	  (CONJ BUT AND OR)
