...
?a5. (Me say-to.v you '(Have you ever taken lessons in music\, dance\, theatre\, drawing\, or another kind of art?))
...
?a9. (Me say-to.v you '(Tell me about ways art helps you cope with stress or negative emotions\.))
...
; the next user input.
;
 '((?a1. ; What types of art do you enjoy, like paintings, music, dance, or theatre?
          ((What types of art do you enjoy ?)))
   (?a5. ; Have you ever taken lessons in music, dance, theatre, drawing, or another kind of art?
          ((Have you ever taken lessons in a kind of art ?)))
   (?a9. ; Tell me about ways art helps you cope with stress or negative emotions. 
...
;
 '((?a1. ; What types of art do you enjoy ?
          (art-type-you-enjoy))
   (?a5. ; Have you ever taken lessons in a kind of art ?
          (art-lessons))
   (?a9. ; How does art help you cope with negative emotions ?
          (ways-art-helps))
   )); end of mapcar
