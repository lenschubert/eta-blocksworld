...
;;  	gist-question: (1 what 2 favorite 2 icecream 1) 
 ...
 (READRULES '*specific-answer-from-favorite-icecream-input*
  '(
 ...
 (READRULES '*thematic-answer-from-favorite-icecream-input*
    '())

 (READRULES '*unbidden-answer-from-favorite-icecream-input*
    '(
    1 (0 favorite food 0)
       2 ((The food I like is ice cream\.)  (favorite-food)) (0 :gist)
    ))
		
 (READRULES '*question-from-favorite-icecream-input*
    '(
    1 (0 what 2 you 0)
