...
?a5. (Me say-to.v you '(What is the best part of advances in technology these days?))
...
?a9. (Me say-to.v you '(What is the hardest part about advances in technology these days?))
...
; the next user input.
;
 '((?a1. ; Do you have a smartphone? What do you use it for?
          ((What do you use your smartphone if you have one ?)))
   (?a5. ; What is the best part of advances in technology these days?
          ((What is the best part of advances in technology ?)))
   (?a9. ; What is the hardest part of advances in technology these days?
...
;
 '((?a1. ; What do you use your smartphone if you have one ?
          (smartphone-use))
   (?a5. ; What is the best part of advances in technology ?
          (technology-best-part))
   (?a9. ; What is the hardest part of advances in technology ?
