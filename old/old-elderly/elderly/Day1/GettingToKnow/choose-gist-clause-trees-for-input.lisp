...
(READRULES '*gist-clause-trees-for-input*
 '(1 (2 what 1 your name 1)
   ...
   1 (2 what 1 you have 2 breakfast 1)
    2 (*specific-answer-from-breakfast-today-input* 
       *unbidden-answer-from-breakfast-today-input*
       *thematic-answer-from-breakfast-today-input*
       *question-from-breakfast-today-input*) (0 :subtrees)
   1 (1 what 2 favorite 2 ice cream 1) 
    2 (*specific-answer-from-favorite-icecream-input* 
       *unbidden-answer-from-favorite-icecream-input*
       *thematic-answer-from-favorite-icecream-input*
       *question-from-favorite-icecream-input*) (0 :subtrees)
