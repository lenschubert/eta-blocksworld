...
?a5. (Me say-to.v you '(What makes this goal important to you? How can it improve your life quality?))
...
?a9. (Me say-to.v you '(What steps have you taken to achive this goal?))
...
; the next user input.
;
 '((?a1. ; Tell me about a personal goal you are working on to stay healthy.
          ((What is a personal goal you are working on to stay healthy ?)))
   (?a5. ; What makes this goal important to you? How can it improve your life quality?
          ((How can being healthier improve your life quality ?)))
   (?a9. ; What steps have you taken to achive this goal?
...
;
 '((?a1. ; What is a personal goal you are working on to stay healthy ?
          (goal-stay-healthy))
   (?a5. ; How can being healthier improve your life quality ?
          (being-healthier-life-quality))
   (?a9. ; What steps have you taken to achieve your goal ?
          (steps-achieve-goal))
   )); end of mapcar
